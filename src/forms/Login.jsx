  ...
  return (
    <div className="flex flex-col items-center justify-center mt-10">
      ...
      <div className="mt-8 w-full max-w-lg">
        <button className="w-full h-12 rounded-lg bg-blue-600 text-white font-semibold flex justify-center items-center transition-transform transform hover:scale-105">Login</button>
      </div>
