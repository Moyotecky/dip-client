...
const ProductDetails = () => {
  ...
  return (
    <div>
      <div className="py-[15px] flex justify-start items-center px-[40px]">
        <BiChevronLeft
          size={28}
          onClick={() => navigate(-1)}
      ...
      <div className="flex flex-wrap justify-center items-center gap-[20px] p-[55px]">
        <div className="w-[700px]">
          <div className="text-[48px] font-[600] text-black">
            S200 Condition Monitoring System
          </div>
          <div className="text-[28px] font-[400] text-[#181826D9] mt-[30px] leading-[1.5]">
          ...
          <div
            onClick={openModal}
            className="cursor-pointer text-[20px] font-[500] text-white w-[350px] h-[70px] flex justify-center items-center mt-[80px] rounded-[35px] bg-[#2577EE] hover:bg-[#1a5bb8] transition-colors duration-300"
          >
            Get Quote
          </div>
        </div>
      ...
      <div className="w-full bg-[#fafafa] gap-[80px] pb-[15px] flex flex-col justify-start p-[40px]">
        <div className="w-[800px]">
          <div className="text-[28px] font-[400] text-black">
            Overview & Features of the S200
          </div>
          <div className="text-[#000000BF] mt-[15px] font-[400] text-[24px] leading-[1.6]">
      ...
      <div className="text-[32px] font-[500] text-black py-[10px] px-[40px]">Similar Products</div>
      <div className="w-full flex flex-wrap justify-start gap-[20px] py-[5px] px-[40px]">
        {products.map((product, index) => (
          <div
            key={index}
            onClick={() => navigate(`/product/${index}`)}
            className="flex justify-around items-center flex-col w-[375px] h-[399px] bg-white rounded-[12px] border-[0.5px] border-[#00000040] cursor-pointer"
          >
            <div>
              <img
                src={product.image}
